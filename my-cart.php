...
echo "<script>
alert('Your Cart hasbeen Updated');
</script>";
}
}
...
mysqli_query($con,"insert into orders(userId,productId,quantity,information)
values('".$_SESSION['id']."','$qty','$val34','$ds')");
...
billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where
id='".$_SESSION['id']."'");
if($query)
{
echo "<script>
alert('Billing Address has been updated');
</script>";
}
}
...
$query=mysqli_query($con,"update users set
shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where
id='".$_SESSION['id']."'");
if($query)
{
echo "<script>
