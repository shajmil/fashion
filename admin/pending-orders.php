    ...
    <div class=" form control">
        <div class="container">
            <div class="row form-control">
                ...
                <a href="change-password.php" class="form-control">back</a>
            </div>
            <div class="">
...
{?>
                ...
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tbody>
                        <?php 
$status='Delivered';
$query=mysqli_query($con,"select users.name as username,orders.information as information,users.email as useremail,users.contactno as usercontact,users.shippingAddress as shippingaddress,users.shippingCity as shippingcity,users.shippingState as shippingstate,users.shippingPincode as shippingpincode,products.productName as productname,products.shippingCharge as shippingcharge,orders.quantity as quantity,orders.orderDate as orderdate,products.productPrice as productprice,orders.id as id  from orders join users on  orders.userId=users.id join products on products.id=orders.productId where orders.	orderStatus!='$status' or orders.orderStatus is null");
$cnt=1;
...
?>
                        <tr>
                            ...
                            <td><?php echo htmlentities($row['information']);?></td>
