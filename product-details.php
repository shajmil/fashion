                                            ...
                                            <div class="price-box">
                                                ...
                                                <form id='moredata'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="hidden" name='pd' value='<?php echo $row['id']; ?>'
                                                            id='prod'>
                                                        <textarea id="info" cols="30" rows="10" class='form-control'
                                                            name='info'></textarea>
                                                        <!-- <textarea name="" id="" cols="30" rows="10"><?php print_r($_SESSION); ?></textarea> -->
                                                        <label for=""><?php echo $_SESSION["'21'"];  ?></label>
                                                    </div>
                                                    <div>
...
while($rw=mysqli_fetch_array($qry))
{
    ...
    function submitData(e) {
        ...
        params.append('color', ntcMatch[1]);
        params.append('info', info);
        params.append('prod', prod);
        axios.post('./add-details.php', params).then(response => {
            console.log(response.data)
            if (response.status === 200) {
                alert("Information stored for the product")
            }
        }).catch(error => console.log(err))
    }
    document.getElementById('moredata').addEventListener('submit', submitData)
    </script>
